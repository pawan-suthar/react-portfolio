      ...
      <div class="w-1/2 h-screen  mx-auto my-auto flex flex-col  justify-center items-center ">
        <div class="w-full shadow-2xl subpixel-antialiased rounded h-64 bg-black border-black mx-auto">
          ...
          >
            ...
            <p class="pb-1">
              Nisi commodo laborum aliquip ipsum excepteur enim ullamco. Tempor
              incididunt pariatur sint velit et mollit laboris in enim aliqua
              irure et ut. Minim tempor nisi nisi est ullamco excepteur mollit
              magna nulla laboris.
            </p>
            <p class="pb-3">
              Nisi commodo laborum aliquip ipsum excepteur enim ullamco. Tempor
